...
import cosmosParkImg from "../../assets/cosmos-park.jpg";
import cosmosParkImg1 from "../../assets/cosmos-park1.jpg";
  ...
  return (
    <div className="cosmos-park">
      ...
      <section className="location">
        <h2>Где находится?</h2>
        <p>Космо Парк расположен в центре города Бишкек по адресу: <strong>7 мкрн, Суеркулов көчөсү, 40а просп. Юнусалиева</strong>.</p>
        <p>
