...
import plazaImg from "../assets/icons/plaza.jpg"
import plazaImg1 from "../assets/icons/plaza1.jpg"
		...
		<div className='dordoy-plaza-container'>
			...
			<section className='dordoy-plaza-about'>
				...
				<p>
					...
					разнообразные товары и услуги. Здесь вы найдете магазины мировых брендов, элитные
					рестораны, а также удобные зоны для отдыха и развлечений. Каждый этаж этого
					многофункционального комплекса предлагает уникальные магазины и места для досуга.
				</p>
			</section>
			...
			<section className='dordoy-plaza-floors'>
				...
				<div className='dordoy-plaza-floor'>
					...
					<p>
						Здесь расположены магазины, предлагающие разнообразие одежды, обуви, аксессуаров и
						ювелирных изделий. Вы найдете популярные бренды, а также уникальные дизайнерские
						изделия.
					</p>
				</div>
				<div className='dordoy-plaza-floor'>
					...
					<p>
						На втором этаже располагаются магазины с последними новинками в области электроники,
						бытовой техники и гаджетов. Множество брендов, таких как Apple, Samsung, и других,
						предлагают продукцию высшего качества.
					</p>
				</div>
				<div className='dordoy-plaza-floor'>
