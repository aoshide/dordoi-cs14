...
import matchImg from "../../assets/match1.jpeg";  // Реальное изображение матча
import logo from "../../assets/logo.png";  // Логотип клуба
  ...
  return (
    <div className="football-container">
      ...
      <section className="club-history">
        <h2>История клуба</h2>
        <p>
          Футбольный клуб «Дордой» был основан в 1995 году и является одним из самых успешных футбольных клубов Кыргызстана. Он многократный чемпион Кыргызстана и регулярно участвует в международных турнирах, таких как Лига чемпионов АФК и Кубок Азиатских чемпионов.
        </p>
        <p>
          Домашним стадионом клуба является «Дордой Арена», вмещающая до 15 000 зрителей. Это символ современного футбольного стадиона в Бишкеке, где проходят важнейшие матчи.
        </p>
      </section>
      ...
      <section className="gallery-section">
        ...
        <div className="gallery">
          <img src="https://via.placeholder.com/300" alt="Gallery Image 1" className="gallery-item" />
          <img src="https://via.placeholder.com/300" alt="Gallery Image 2" className="gallery-item" />
          <img src="https://via.placeholder.com/300" alt="Gallery Image 3" className="gallery-item" />
        </div>
      </section>
      <section className="location">
        <h2>Где находится?</h2>
        <p>Космо Парк расположен в центре города Бишкек по адресу: <strong> ул. Абдрахманова 230А</strong>.</p>
        <p>
